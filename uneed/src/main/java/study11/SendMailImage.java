...
public class SendMailImage {
    ...
    public static MimeMessage getMimeMessage(Session session) throws Exception {
        ...
        // 读取本地文件
        //        InputStream path = SendMailImage.class.getClassLoader().getResourceAsStream("doc/1.jpg");
        DataHandler dh = new DataHandler(new FileDataSource(("src\\main\\resources\\doc\\1.jpg")));
        //        SendMailImage.class.getClassLoader().getResourceAsStream("doc/1.jpg");
        // 将图片数据添加到"节点"
        ...
        // 读取本地文件
        DataHandler dh2 = new DataHandler(new FileDataSource(String.valueOf("src\\main\\resources\\doc\\1.doc")));
        // 将附件数据添加到"节点"
