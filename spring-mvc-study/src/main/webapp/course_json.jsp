    ...
    <div class="newcontainer" id="course_intro">
        ...
        <div class="course_info">
            ...
            <div class="course_state">
                <ul>
                    <li><span>Learn Gay</span> <em id="learningNum"></em></li>
                    <li class="course_hour"><span>Learn Time</span> <em
                            class="ft-adjust"><span id="duration"></span>秒</em></li>
                    <li><span>learn simple</span> <em id="levelDesc"></em></li>
                </ul>
            </div>
        ...
        <div class="course_list">
            <div class="outline">
                <h3 class="chapter_introduces">Learn content</h3>
                <div class="course_shortdecription"></div>

                <h3 class="chapter_catalog">Learn content</h3>
                <ul id="couList">
